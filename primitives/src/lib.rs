...
pub use v2::{
	...
	ValidatorSignature, ValidityAttestation, ValidityError, Vote, VoteWeight, MaxValidators,
	ASSIGNMENT_KEY_TYPE_ID, LOWEST_PUBLIC_ID, MAX_CODE_SIZE, MAX_HEAD_DATA_SIZE, 
