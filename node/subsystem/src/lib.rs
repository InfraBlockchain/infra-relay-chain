...
pub mod messages {
	...
	pub use infrablockspace_node_subsystem_types::messages::*;
}
...
pub type FromOrchestra<M> = infrablockspace_overseer::gen::FromOrchestra<M, OverseerSignal>;

/// Specialized subsystem instance type of subsystems consuming a particular message type.
pub type SubsystemInstance<Message> =
	infrablockspace_overseer::gen::SubsystemInstance<Message, OverseerSignal>;

/// Spawned subsystem.
pub type SpawnedSubsystem = infrablockspace_overseer::gen::SpawnedSubsystem<SubsystemError>;
