...
//! EXECUTION: Some(Wasm), WASM-EXECUTION: Compiled, CHAIN: Some("infrabs-dev"), DB CACHE: 1024
...
// --output=./runtime/infrabs/src/weights/runtime_parachains_paras_inherent.rs
