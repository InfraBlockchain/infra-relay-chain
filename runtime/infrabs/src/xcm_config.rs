...
/// infrabs Relay recognizes/respects the Statemint chain as a teleporter.
...
impl xcm_executor::Config for XcmConfig {
	...
	// infrabs Relay recognises no chains which act as reserves.
	type IsReserve = ();
